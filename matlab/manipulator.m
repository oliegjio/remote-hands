...
effector = getTransform(robot, homeConf, 'node3', 'base'); % End effector transformation matrix.
...
while true
    if t.BytesAvailable > 0
        ...
        [ikSolution, ikInfo] = ik('node3', effector, weights, homeConf);
        ...
        for i = 1:size(ikSolution)
            ikSolution(i).JointPosition = ikSolution(i).JointPosition * 15;
        end
